...
public class OAuthServiceImpl implements IOAuthService {
	 ...
	 * @Return : Client
	 */
	private ApiClient applyClientByOrg(Organization organization, String level) {
	...
	public ApiAccessToken applyAccessToken(String orgId,int maxPageSize, Date expireTime, String sourceOwner, String level,
		...
		if (StringUtils.isNotBlank(orgId)) {
			Organization organization = this.organizationService.findById(orgId);

			// 代理申请CLient
			ApiClient client = this.applyClientByOrg(organization, level);
			if (client != null) {
