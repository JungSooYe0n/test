 ...
 * 正则util
 * 
 * @Type RegexUtils.java
 * @author 谷泽昊
 * @date 2017年11月20日 下午3:01:54
 * @version
 */
public class RegexUtils {
	 ...
	 * 验证Email
	 * 
	 * @date Created at 2017年11月20日 下午3:09:37
	 * @Author 谷泽昊
	 * @param email
	 ...
	 *            、150、151、152、157（TD专用）、158、159、187、188（TD专用）
	 *            联通的号段：130、131、132、155、156（世界风专用）、185（未启用）、186（3g）
	 *            电信的号段：133、153、177、180（未启用）、189
	 * @return 验证成功返回true，验证失败返回false
	 */
	 ...
	 * 是否包含连词符
	 * 
	 * @date Created at 2017年11月20日 下午3:09:32
	 * @Author 谷泽昊
	 * @param username
	 * @return
	 */
	 ...
	 * 判断密码位数
	 * 
	 * @date Created at 2017年11月20日 下午3:07:34
	 * @Author 谷泽昊
	 * @param password
	 * @return
	 */
	public static boolean isLowSafely(String password) {
		//20190918 需求更改  要求长度在8~16位
	...
	/**
	 * 判断括号是否匹配
	 * @date Created at 2018年11月9日  上午10:21:05
