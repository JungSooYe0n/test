...
import com.trs.netInsight.widget.user.service.impl.SubGroupServiceImpl;
...
public class UserUtils {
	...
	public static User checkOrganization(User user) {
		...
		if (StringUtils.isNotBlank(user.getOrganizationId())) {
			IOrganizationService organizationService = SpringUtil.getBean(IOrganizationService.class);
			Organization organization = organizationService.findById(user.getOrganizationId());
			SubGroupServiceImpl subGroupService = SpringUtil.getBean(SubGroupServiceImpl.class);
			String subGroupId = user.getSubGroupId();
			SubGroup subGroup = null;
			if (StringUtil.isNotEmpty(subGroupId)){
				subGroup = subGroupService.findOne(user.getSubGroupId());
			}
			if (subGroup != null){
