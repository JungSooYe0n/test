...
//					start = com.trs.netInsight.support.fts.util.DateUtil.stringToDate(strings[0], com.trs.netInsight.support.fts.util.DateUtil.yyyyMMdd3);
//				}
//			}
...
//
//				// 机构开始时间
//				Date beginDate = com.trs.netInsight.support.fts.util.DateUtil.dateAfter(endDate, -dataDate);
//				if (beginDate != null){
...
//			}
//			if (null != start){
//				timeArray[0] = com.trs.netInsight.support.fts.util.DateUtil.date2String(start, com.trs.netInsight.support.fts.util.DateUtil.yyyyMMddHHmmssSSS);
//				timeArray[1] = com.trs.netInsight.support.fts.util.DateUtil.date2String(endDate, com.trs.netInsight.support.fts.util.DateUtil.yyyyMMddHHmmssSSS);
//				return timeArray;
//			}
//
//		return null;
