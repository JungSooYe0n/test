...
public class Const {
	 ...
	 * hybase传统库
	 */
	public static String HYBASE_NI_INDEX = "system2.traditionalmedia_180330";// ;system2.weixin_180325
	//public static final String HYBASE_NI_INDEX = "system2.traditionalmedia_180330_dabiaoceshi";// ;system2.weixin_180325
	/**
	 * hybase传统库2
	 */
	public static final String HYBASE_NI = "system2.traditionalmedia_180330";// ;system2.weixin_180325
	//public static final String HYBASE_NI = "system2.traditionalmedia_180330_dabiaoceshi";// ;system2.weixin_180325
	/**
	 * hybase微博库
	 */
...
//	public static final String WEIBO = "weibo_new";
	 ...
	 * 预计为库名
	 */
	public static final String ES_INDEX_APP = "dc_app_0928";
	/**
	 * 预计为库名
	 */
	public static final String ES_INDEX_E_PAPER = "dc_dianzibao_1128";
	...
	public static final String EXCLUDE_WECHAT_WEIBO = "国内新闻;国内论坛;国内博客;国内新闻_电子报;国内新闻_手机客户端;国外新闻";
	...
	public static final String[] CHINA_AREA = { "北京", "天津", "上海", "重庆", "河北", "山西", "辽宁", "吉林", "黑龙江", "江苏", "浙江", "安徽",
			...
			"宁夏", "新疆", "香港", "澳门" };
	public static final String[] ESGROUPNAME = { "国内新闻", "国内论坛", "国内新闻_手机客户端", "国内新闻_电子报", "国内博客", "微博" };
...
//			put("location", "CQ_LOCATIONS");
//			put("weixinlocation", "CQ_LOCATIONS");
//			put("weibolocation", "CQ_LOCATIONS");
			/**2019.9.30 因为CQ_LOCATIONS字段在微信库是别名 无法添加 所以更换字段
				**/
			put("location", "CATALOG_AREA1");
			put("weixinlocation", "CATALOG_AREA1");
			put("weibolocation", "CATALOG_AREA1");
			// put("location", "CATALOG_AREA");
			// put("weixinlocation", "CATALOG_AREA");
			// put("weibolocation", "CATALOG_AREA");
	...
	/**
	 * 收藏列表和素材库 source和geoupName的对应关系
	 */
	public static final Map<String, String> FAVOURITES_SOURCE_GROUPNAME = new HashMap<String, String>() {
		private static final long serialVersionUID = 1L;
    ...
    @PostConstruct
    public void init(){
		//ISystemConfigService systemConfigService = SpringUtil.getBean(ISystemConfigService.class);
