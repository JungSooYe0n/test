...
public interface IReportService {
	 ...
	 * @throws TRSException
	 */
	public Object getFavouritesByCondition(User user, int pageNo, int pageSize,List<String> groupName,String keyword,String fuzzyValueScope,String invitationCard,String forwarPrimary) throws TRSException;
