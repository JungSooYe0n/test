...
//			}
	...
	private InputStream getRedLine() throws IOException {
		...
		if(file.exists()){
            ...
            InputStream resourceAsStream = this.getClass().getClassLoader().getResourceAsStream("report/littleTemplate/RedLine.png");
...
//					}
	...
	private InputStream getRedPictue() throws IOException {
		...
		if(file.exists()){
			...
			InputStream resourceAsStream = this.getClass().getClassLoader().getResourceAsStream("report/littleTemplate/material.png");
			return resourceAsStream;
		}
	}
	/**
