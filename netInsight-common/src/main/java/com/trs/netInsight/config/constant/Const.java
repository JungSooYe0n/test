 ...
 */
     ...
     * 媒体类型: 自媒体号 + 博客
     */
    public static final List<String> MEDIA_TYPE_ZIMEITI_BOKE = Arrays.asList(Const.GROUPNAME_ZIMEITI, Const.PAGE_SHOW_ZIMEITI, Const.GROUPNAME_LUNTAN, Const.PAGE_SHOW_LUNTAN, Const.GROUPNAME_BOKE, Const.PAGE_SHOW_BOKE);
 ...
 */
    ...
    public static final Map<String, String> PAGE_SHOW_PROVINCE_NAME = new HashMap<String, String>() {
...

        {
            ...
            put("内蒙古自治区", "内蒙古");
            put("中国\\内蒙古自治区", "内蒙古");
            put("亚洲\\中国\\内蒙古自治区", "内蒙古");
            put("广西壮族自治区", "广西");
            put("中国\\广西壮族自治区", "广西");
            put("亚洲\\中国\\广西壮族自治区", "广西");
            put("西藏自治区", "西藏");
            put("中国\\西藏自治区", "西藏");
            put("亚洲\\中国\\西藏自治区", "西藏");
            put("宁夏回族自治区", "宁夏");
            put("中国\\宁夏回族自治区", "宁夏");
            put("亚洲\\中国\\宁夏回族自治区", "宁夏");
            put("新疆维吾尔族自治区", "新疆");
            put("中国\\新疆自治区", "新疆");
            put("亚洲\\中国\\新疆维吾尔族自治区", "新疆");
            put("香港特别行政区", "香港");
            put("中国\\香港特别行政区", "香港");
            put("亚洲\\中国\\香港特别行政区", "香港");
            put("澳门特别行政区", "澳门");
            put("中国\\澳门特别行政区", "澳门");
            put("亚洲\\中国\\澳门特别行政区", "澳门");
        }
    };
    ...
    public static final Map<String, String> MEDIA_PROVINCE_NAME = new HashMap<String, String>() {
...

        {
            ...
            put("青海", "亚洲\\\\中国\\\\青海省");
            put("台湾", "亚洲\\\\中国\\\\台湾省");
            put("内蒙古", "亚洲\\\\中国\\\\内蒙古自治区");
            put("广西", "亚洲\\\\中国\\\\广西壮族自治区");
            put("西藏", "亚洲\\\\中国\\\\西藏自治区");
            put("宁夏", "亚洲\\\\中国\\\\宁夏回族自治区");
            put("新疆", "亚洲\\\\中国\\\\新疆维吾尔族自治区");
            put("香港", "亚洲\\\\中国\\\\香港特别行政区");
            put("澳门", "亚洲\\\\中国\\\\澳门特别行政区");
            put("其他", "其他");
        }
    };
