...
public class WordTemplateFactory {
	 ...
	 * 读取多个模板合并输出指定位置
	 * 
	 * @author slzs 2017年4月27日 上午9:51:35
	 * @param outFilePath
	 *            指定输出文件路径
	 * @param templateInputStreams
	 *            模板文件输入流,多个
	 * @return true 成功 false 失败
	 */
	public boolean mergeDocument(String outFilePath, InputStream... templateInputStreams) {
	 ...
	 * @return true 成功 false 失败
	 */
	public boolean mergeDocument(String outFilePath, String[] templateFilePaths) {
	 ...
	 * @return 合并后的文件流
	 */
	public OutputStream mergeDocument(InputStream... templateInputStreams) {
	 ...
	 * @return 合并后的文件流
	 */
	public OutputStream mergeDocument(String... templateFilePaths) {
		return mergeAll(null, templateFilePaths);
	}

	private OutputStream mergeAll(String outFilePath, Object[] templates) {
	...
	private void mergeOne(Object template) throws Exception {
