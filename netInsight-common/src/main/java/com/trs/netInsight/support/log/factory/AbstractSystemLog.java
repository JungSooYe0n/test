...
public abstract class AbstractSystemLog {
	 ...
	 * @param sessionDAO
	 */
	public void init(MysqlSystemLogRepository mysqlSystemLogRepository, SessionDAO sessionDAO, UserRepository userRepository,OrganizationRepository organizationRepository) {
