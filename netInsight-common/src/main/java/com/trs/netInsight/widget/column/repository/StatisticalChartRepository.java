...
@Repository
public interface StatisticalChartRepository extends PagingAndSortingRepository<StatisticalChart, String>, JpaSpecificationExecutor<StatisticalChart>, JpaRepository<StatisticalChart, String> {
