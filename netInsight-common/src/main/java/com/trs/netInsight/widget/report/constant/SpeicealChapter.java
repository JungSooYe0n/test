...
public enum SpeicealChapter {
    ...
    OPINIONANALYSIS(ReportConst.OPININOANALYSIS, ReportConst.CHART),
    ...
    //传播分析时间轴 - 新闻
    NEWSPROPAFATIONANALYSISTIMELIST(ReportConst.NEWSPROPAFATIONANALYSISTIMELIST,ReportConst.CHART),
    //传播分析时间轴 - 自媒体
    WEMEDIAPROPAFATIONANALYSISTIMELIST(ReportConst.WEMEDIAPROPAFATIONANALYSISTIMELIST,ReportConst.CHART),
    //活跃账号
