...
//					wordCloud = chartAnalyzeService.getWordCloud(indexTab.isServer(),queryBuilder.asTRSL(), sim,irSimflag,irSimflagAll, com.trs.netInsight.config.getEntityType(), queryBuilder.getPageSize(),"column", data);
			...
			/*}else {
				...
				try {
					wordCloud = chartAnalyzeService.getWordCloud(indexTab.isServer(),queryBuilder.asTRSL(), sim,irSimflag,irSimflagAll, com.trs.netInsight.config.getEntityType(), queryBuilder.getPageSize(),"column", queryBuilder.getDatabase());
