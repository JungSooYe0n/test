...
import static com.trs.netInsight.widget.report.constant.SimplerReportConst.NEWSTOP10;
import static com.trs.netInsight.widget.report.constant.SimplerReportConst.NEWSTOP10key;
...
import static com.trs.netInsight.widget.report.constant.SimplerReportConst.WECHATTOP10;
import static com.trs.netInsight.widget.report.constant.SimplerReportConst.WECHATTOP10key;
...
import static com.trs.netInsight.widget.report.constant.SimplerReportConst.WEIBOTOP10;
import static com.trs.netInsight.widget.report.constant.SimplerReportConst.WEIBOTOP10key;
...
public class SimpleReportTask implements Runnable {
	...
	private ICommonListService commonListService = (ICommonListService) ObjectContainer
			.getBean(ICommonListService.class);
	private ICommonChartService commonChartService = (ICommonChartService) ObjectContainer
			.getBean(ICommonChartService.class);
	/**
	 * 任意关键词
	 */
			...
			for (String simChapter : chapters) {
				switch (simChapter) {
					...
					case DATASOURCEANALYSISkey:
						...
						dataSourceOfDataIT.setType(ColumnConst.CHART_PIE);
					...
					case WEBSITESOURCETOP10key:
						...
						websiteSource.setType(ColumnConst.CHART_BAR);
