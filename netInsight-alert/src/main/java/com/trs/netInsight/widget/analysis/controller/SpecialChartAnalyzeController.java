...
public class SpecialChartAnalyzeController {
     ...
     * 来源类型统计
     *
     * @param timeRange 时间类型 今天，24小时，几天
     * @param specialId 专项id
     * @param area      检索开始时间
     * @param industry  检索结束时间
     * @return
     * @throws TRSException
...
//			map.put("param", chartParam);
     ...
     *
     * @param specialId   专题ID
     * @param timeRange   时间范围（eg:24h,1d,7d,1m 或 2016-05-26 22:00:00;2016-05-27
     *                    04:00:00）
     * @param entityType  实体类型（通用：keywords；人名:people；地名:location；机构名:agency）
     * @param articleType 文章类型（全部：all；新闻：news；微博：weibo；微信：weixin；客户端：app）
     * @return Object
