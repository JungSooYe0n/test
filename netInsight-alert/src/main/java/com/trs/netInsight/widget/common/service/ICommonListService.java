...
public interface ICommonListService {
     ...
     * @throws TRSException
     */
    <T extends IQueryBuilder> InfoListResult queryPageList(T builder, boolean sim,
     ...
     * @throws TRSException
     */
    <T extends IQueryBuilder> PagedList<FtsDocumentCommonVO> queryPageListNoFormat(T builder, boolean sim,
     ...
     * @throws TRSException
     */
    <T extends IQueryBuilder> PagedList<FtsDocumentCommonVO> queryPageListNoSort(T builder, boolean sim,
                                                                                 boolean irSimflag, boolean irSimflagAll, String type, String groupName) throws TRSException;
     ...
     * @throws TRSException
     */
    <T extends IQueryBuilder> InfoListResult queryPageListForHot(T builder, String groupName, User user, String type, Boolean isCalculateSimNum) throws TRSException;
     ...
     * @throws TRSException
     */
    <T extends IQueryBuilder> PagedList<FtsDocumentCommonVO> queryPageListForHotNoFormat(T builder, String type, String groupName) throws TRSException;
     ...
     * @throws TRSException
     */
    <T extends IQueryBuilder> Object queryListGroupNameStattotal(T builder, boolean sim,
     ...
     */
    <T extends IQueryBuilder> Long ftsCount(T builder, boolean isSimilar, boolean irSimflag, boolean irSimflagAll, String type, String groupName) throws TRSException;
     ...
     * @throws TRSSearchException
     */
    <T extends IQueryBuilder> Long ftsCount(T builder, boolean isSimilar, boolean irSimflag, boolean irSimflagAll, String type) throws TRSException;
     ...
     * @throws TRSSearchException
     */
    <T extends IQueryBuilder> GroupResult categoryQuery(T builder, boolean isSimilar, boolean irSimflag, boolean irSimflagAll, String groupField, String type, String groupName) throws TRSException;
     ...
     * @throws TRSSearchException
     */
    <T extends IQueryBuilder> GroupResult categoryQuery(T builder, boolean isSimilar, boolean irSimflag, boolean irSimflagAll, String groupField, String type) throws TRSException;
